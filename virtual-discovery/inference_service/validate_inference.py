"""
validate_inference.py — End-to-End Validation Script for Audio Toxicity Inference
...
Usage:
    ...
    python validate_inference.py --audio path/to/custom.wav
    python validate_inference.py --endpoint http://gpu-host:8080/predictions/audio_toxicity
"""
